...
const Page : React.FC = (_props) => {
    ...
    // const appEditor = useRef<DrawerHandler>(null)
    // const createApp = useRef<SheetHandler>(null)

    const createApp = useDialog();
            ...
            actions={[
                {
                    ...
                    fn: () => {
                        ...
                        // appEditor.current?.open(<AppEditor />)
                        // createApp.current?.dialog(
                        //     `Create App`,
                        //     <CreateApp onSuccess={_app => {
                        //         toast.success(_app.message || `App created successfully`)
                        //         router.push(`/app/${_app.appId}/dashboard`)
                        //     }} />
                        // )
                        const createAppDialog = createApp.show({
                            title: `Create App`,
